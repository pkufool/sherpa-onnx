...
Keyword Spotting with sherpa-onnx using websocket.
...
int32_t main(int32_t argc, char *argv[]) {
  ...
  sherpa_onnx::KwsWebsocketServerConfig config;
  ...
  sherpa_onnx::KwsWebsocketServer server(io_conn, io_work, config);
  server.Run(port);
